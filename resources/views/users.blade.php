...
<div class="flex flex-wrap items-center justify-between">
    ...
    <button data-modal-id="create-utilisateur-modal" type="button" class="inline-flex items-center text-white focus:outline-none focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 bg-blue-800 hover:bg-blue-700 focus:ring-blue-700 border-blue-700 open-modal">
...
<div class="relative z-10 hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true" id="create-utilisateur-modal">
    ...
    <div class="fixed inset-0 z-10 overflow-y-auto">
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <form action="{{ route('utilisateurs.store') }}" method="POST" class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                @csrf
