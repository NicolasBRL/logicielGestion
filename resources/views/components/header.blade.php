            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
                <ul class="flex flex-col mt-4 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-transparent bg-gray-800 md:bg-transparent border-gray-700">
                    ...
                    <li>
                        ...
                        <button id="dropdownAvatarNameButton" data-dropdown-toggle="dropdownAvatarName" class="flex items-center text-sm font-medium capitalize rounded-full hover:text-blue-600 md:mr-0 text-gray-400" type="button">
                            {{auth()->user()->name}}
